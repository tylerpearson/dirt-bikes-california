...
export const sanLuisObispoRoutes: Route[] = [
  ...
  },
  {
    ...
    "description": "30S06 is an OHV road open to all vehicles in the La Panza country, mixing rocky benches and sandy stretches through dense chaparral. A solid intermediate green-sticker ride that links into the surrounding Pozo OHV network, seasonal when wet.",
    "distanceMiles": 4,
    "difficulty": "Moderate",
  ...
  },
  {
    ...
    "description": "12N03 (Old Sierra) is a short OHV road open to all vehicles on the approach to the Sierra Madre high country, rocky, high-clearance tread with chaparral and grassland views. A brief green-sticker option best paired with the longer roads nearby; seasonal.",
    "distanceMiles": 2,
    "difficulty": "Moderate",
  ...
  },
  {
    ...
    "description": "Fernandez Road (28S02) is a quieter road open to street-legal vehicles only, through the Santa Lucia backcountry near Pozo, with graded dirt and rocky sections through oak and chaparral. A relaxed plated ride and a way to link the area without the technical or seasonal demands of the OHV roads.",
    "distanceMiles": 6.6,
    "difficulty": "Moderate",
