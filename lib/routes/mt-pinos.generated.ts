...
export const mtPinosRoutes: Route[] = [
  ...
  },
  {
    ...
    "description": "7N03 (Mutau) runs deep toward Mutau Flat on the edge of the Sespe backcountry, a long road open to all vehicles, mixing forest and meadow with sandy and rocky stretches. Remote, quiet green-sticker mileage. Go prepared; seasonal.",
    "distanceMiles": 9.9,
    "difficulty": "Moderate",
  ...
  },
  {
    ...
    "description": "8N06 threads Apache Canyon in the sandstone badlands on the Cuyama side of the range, a road open to all vehicles, with sandy washes, rocky benches, and striking eroded rock. A fun, scenic green-sticker ride that pairs with neighboring Quatal Canyon.",
    "distanceMiles": 8.9,
    "difficulty": "Moderate",
  ...
  },
  {
    ...
    "description": "9N21 (Scott Russell) is a road open to all vehicles in the forested country between Frazier Mountain and Lockwood Valley, mixing graded and rockier stretches through pine and oak. A solid intermediate green-sticker ride linking the area's OHV network; seasonal.",
    "distanceMiles": 5.1,
    "difficulty": "Moderate",
  ...
  },
  {
    ...
    "access": {
      ...
      "note": "Per the MVUM, Quatal Canyon OHV is mixed: some segments are open to all vehicles (green-sticker OK) and others are open to street-legal vehicles only, so access goes segment by segment. Read the signs at each junction; registration + spark arrestor required.",
      "source": "USFS Motor Vehicle Use Map (MVUM), 2026"
    },
    "highlights": [
  ...
  },
  {
    ...
    "description": "9N10 is the graded access road into the Ballinger Canyon OHV area on the Cuyama side, an easy plated ride to the staging area and campground that anchors a big network of OHV trails. The road itself is open to street-legal vehicles only; the OHV trail riding branches off it.",
    "distanceMiles": 3.3,
    "difficulty": "Easy",
