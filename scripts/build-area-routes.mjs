...
// Greedy-stitch line parts into one ordered path by nearest endpoints. This is
// the older single-path stitcher (no gap split): kept as-is rather than
// switched to the gap-aware scripts/lib/pipeline.mjs `stitchParts`, since that
// would change committed route data (see plan 012's "what this plan is NOT").
